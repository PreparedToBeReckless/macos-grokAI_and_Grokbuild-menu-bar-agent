...
| **Current version** | 0.0.42 (see `macos_grok_overlay/about/version.txt`) |
...
Fork maintained by reckless; modifications made using Grok (xAI) — no manual coding by reckless.
```