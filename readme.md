...
<p align="center">
  <h1 align="center"><code>macos-grokAI_and_Grokbuild-menu-bar-agent</code></h1>
</p>
...
**Download:** [Grok-Overlay-0.0.52.dmg](https://github.com/PreparedToBeReckless/macos-grokAI_and_Grokbuild-menu-bar-agent/releases/latest)  
Open the DMG and drag both apps to Applications.

[![DMG Installer](images/dmg-installer-preview.png)](https://github.com/PreparedToBeReckless/macos-grokAI_and_Grokbuild-menu-bar-agent/releases/latest)
...
```bash
python3 -m pip install "git+https://github.com/PreparedToBeReckless/macos-grokAI_and_Grokbuild-menu-bar-agent.git"
```
